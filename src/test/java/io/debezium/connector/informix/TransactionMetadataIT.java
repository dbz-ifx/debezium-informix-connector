...
public class TransactionMetadataIT extends AbstractConnectorTest {
    ...
    public void before() throws SQLException {
        ...
        connection.execute("CREATE TABLE IF NOT EXISTS tablea (id int not null, cola varchar(30), primary key (id))",
                "CREATE TABLE IF NOT EXISTS tableb (id int not null, colb varchar(30), primary key (id))");
        connection.execute("TRUNCATE TABLE tablea", "TRUNCATE TABLE tableb");
