...
public class InformixMultipleConnectionsRestartConnectorIT extends AbstractConnectorTest {
    ...
    public void restartWithinTransaction() throws Exception {
        ...
        final Configuration config = TestHelper.defaultConfig()
                .with(InformixConnectorConfig.SNAPSHOT_MODE, InformixConnectorConfig.SnapshotMode.SCHEMA_ONLY)
                .build();
        ...
        conn1.execute("insert into testdb:test_restart values('conn-1-stage-1-0')");
