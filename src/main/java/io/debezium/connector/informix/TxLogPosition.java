...
public class TxLogPosition implements Nullable, Comparable<TxLogPosition> {
    ...
    public static TxLogPosition valueOf(Lsn commitLsn, Lsn changeLsn) {
        if ((commitLsn == null || commitLsn.equals(Lsn.NULL) && (changeLsn == null || changeLsn.equals(Lsn.NULL)))) {
            ...
            return new TxLogPosition(commitLsn, changeLsn, 0x00, Lsn.valueOf(0x00L));
        }
    }
    ...
    public static TxLogPosition cloneAndSet(TxLogPosition position, Lsn commitLsn, Lsn changeLsn, Integer txId, Lsn beginLsn) {
        ...
        return valueOf(commitLsn.compareTo(position.commitLsn) > 0 ? commitLsn : position.commitLsn,
                changeLsn.compareTo(position.changeLsn) > 0 ? changeLsn : position.changeLsn, txId >= 0 ? txId : position.txId,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(commitLsn, that.commitLsn) && Objects.equals(changeLsn, that.changeLsn) && Objects.equals(txId, that.txId)
