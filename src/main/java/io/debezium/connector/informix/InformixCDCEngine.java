...
public class InformixCDCEngine {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(InformixCDCEngine.class);
    ...
    private IfxCDCEngine buildCDCEngine(String url, String user, String password, InformixDatabaseSchema schema) throws SQLException {
    ...
    public interface StreamHandler {
        ...
        boolean accept(IfmxStreamRecord streamRecord) throws SQLException, IfxStreamException, InterruptedException;
