...
public class InformixDatabaseSchema extends HistorizedRelationalDatabaseSchema {
    ...
    public InformixDatabaseSchema(InformixConnectorConfig connectorConfig, TopicNamingStrategy<TableId> topicNamingStrategy, InformixValueConverters valueConverters,
        ...
        super(connectorConfig, topicNamingStrategy, connectorConfig.getTableFilters().dataCollectionFilter(), connectorConfig.getColumnFilter(),
                new TableSchemaBuilder(valueConverters, schemaNameAdjuster, connectorConfig.customConverterRegistry(),
                        connectorConfig.getSourceInfoStructMaker().schema(), connectorConfig.getFieldNamer(), connectorConfig.multiPartitionMode()),
    ...
    public void applySchemaChange(SchemaChangeEvent schemaChange) {
        ...
        // just a single table per DDL event for Ifx
